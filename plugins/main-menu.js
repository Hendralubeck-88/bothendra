 ...
 if (teks == 'edukasi') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `📛)ഒ Info Bot`, rowId: ".botinfo", description: "✧ Info nya HENDRA LUBECK🇮🇩 ><"},
...
const listMessage = {
  text: tek,
  footer: '© HENDRA LUBECK🇮🇩 | ALL RESERVED',
...
//-------DOC TEMPLATE
    const message = {
            ...
            pageCount: fpagedoc,
            caption: text,
            footer: titlebot + '\n⚡ Supported By HENDRA LUBECK🇮🇩',
            templateButtons: [
                {
                    urlButton: {
                        displayText: `${namebot}`,
                        url: 'https://chat.whatsapp.com/I08rvJzSqTRDXYkRh3btHs'
                    }
                },
                {
                    urlButton: {
